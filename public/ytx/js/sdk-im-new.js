  ...
  function RL_YTX() {
    ...
    var YTX_Methods = {
      ...
      sendMsg: function (content) {
        ...
        if (content.indexOf('UserAuth') === -1 && !self.checkOnline(function () {
  ...
  function RL_Chat() {
    ...
    var chatMethods = {
      ...
      noticeAppFn: function(obj) {
        ...
        } else if (obj.msgType === commonConfig.msgTypeNo.friendMsg) { //好友消息
          return obj
        } else {
    ...
    this.__proto__ = {
      ...
      msgRead: function (data, callback, onerror) {
        data = commonMethods.getParam(data);
        self.msgOperation(commonMethods.assign(data, {type: 3}), function (e) {
          callback(e);
        }, function (e) {
          if (onerror) {
            onerror(e);
      ...
      msgBack: function (data, callback, onerror) {
        data = commonMethods.getParam(data);
        self.msgOperation(commonMethods.assign(data, {type: 1}), function (e) {
          callback(e);
        }, function (e) {
          if (onerror) {
            onerror(e);
      ...
      processSyncMsg: function (type, endVersion, requestType, repeat) {
        ...
        function reGet(err) {
          if (err.code === 171137) {  //离线消息拉取失败，进行重新拉取
            commonConfig.syncMsgPorcessing = false;
  ...
  function RL_MEET() {
    ...
    this.__proto__ = {
      ...
      StartWhiteboardSharing: function(data, callback, onError) {
        meetMethods.buildConferenceMsg("/REST/Conference/MediaControl/StartWhiteboardSharing?source=SDK", commonMethods.assign({confId: self.confId}, data), function (e) {
          var resp = JSON.parse(e.result);
          if (resp.statusCode !== "000000") {
            onError(resp);
            return;
      ...
      StopWhiteboardSharing: function(data, callback, onError) {
        meetMethods.buildConferenceMsg("/REST/Conference/MediaControl/StopWhiteboardSharing?source=SDK", commonMethods.assign({confId: self.confId}, data), function (e) {
          var resp = JSON.parse(e.result);
          if (resp.statusCode !== "000000") {
            onError(resp);
            return;
      ...
      ConferenceUpdate: function(data, callback, onError) {
        meetMethods.buildConferenceMsg("/REST/Conference/Update?source=SDK", commonMethods.assign({confId: self.confId}, data), function (e) {
          var resp = JSON.parse(e.result);
          if (resp.statusCode !== "000000") {
            onError(resp);
            return;
      ...
      RoomList: function(data, callback, onError) {
        meetMethods.buildConferenceMsg(
          "/REST/Conference/Room/List?source=SDK", commonMethods.assign({confId: self.confId}, data), function (e) {
            var resp = JSON.parse(e.result);
            if (resp.statusCode !== "000000") {
              onError(resp);
              return;
      ...
      GetMeetMemberList: function(data, callback, onError) {
        meetMethods.buildConferenceMsg(
          "/REST/Conference/Member/List?source=SDK", commonMethods.assign({confId: self.confId}, data), function (e) {
            var resp = JSON.parse(e.result);
            callback(resp);
          }, onError);
      },
      ...
      StartPublishVoice: function(data, callback, onError) {
        ...
        meetMethods.buildConferenceMsg("/REST/Conference/MediaControl/StartPublishVoice?source=SDK", commonMethods.assign({confId: self.confId}, data), callback, onError);
      },
      // 停止发布语音
      StopPublishVoice: function(data, callback, onError) {
        ROOT.RL_Media.deployVideoVoice(false, "audio");
        meetMethods.buildConferenceMsg("/REST/Conference/MediaControl/StopPublishVoice?source=SDK", commonMethods.assign({confId: self.confId}, data), callback, onError);
      },
      //  发布视频
      StartPublishVideo: function(data, callback, onError) {
        ROOT.RL_Media.deployVideoVoice(true, "video");
        meetMethods.buildConferenceMsg("/REST/Conference/MediaControl/StartPublishVideo?source=SDK", commonMethods.assign({confId: self.confId}, data), function (e) {
          var resp = JSON.parse(e.result);
          if (resp.statusCode === "000000") {
            callback(resp);
          } else {
      ...
      StopPublishVideo: function(data, callback, onError) {
        ...
        meetMethods.buildConferenceMsg("/REST/Conference/MediaControl/StopPublishVideo?source=SDK", commonMethods.assign({confId: self.confId}, data), function (e) {
          var resp = JSON.parse(e.result);
          if (resp.statusCode === "000000") {
            callback(resp);
          } else {
      ...
      InviteMember: function(data, callback, onError) {
        meetMethods.buildConferenceMsg("/REST/Conference/Member/Invite?source=SDK", commonMethods.assign({confId: self.confId}, data), function (e) {
          var resp = JSON.parse(e.result);
          if (resp.statusCode === "000000") {
            callback(resp);
          } else {
      ...
      MediaControl: function(data, callback, onError) {
        meetMethods.buildConferenceMsg("/REST/Conference/Member/MediaControl?source=SDK", commonMethods.assign({confId: self.confId}, data), callback, onError);
      },
      //更新成员信息
