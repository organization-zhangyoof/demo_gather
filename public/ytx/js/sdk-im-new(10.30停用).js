        ...
        var YTX_Methods = {
            ...
            onResponseErr: function (obj) {
                ...
                if (obj["1"] === commonConfig.msgTypeNo._getMyInfo && obj["6"] == commonConfig.reqErrCode.AccountInexistent) {
                    ...
                    return;
                } else if ((obj["6"] >= commonConfig.reqErrCode.NoAppkey - 1 && obj["6"] <= commonConfig.reqErrCode.RegistOver - 1) || (obj["6"] >= commonConfig.reqErrCode.NoAppkey - 1 && obj["6"] <= commonConfig.reqErrCode.RegistOver - 1) || obj["6"] == 219000) {
                    YTX_CONFIG.reconnectNum = 0;
                    YTX_CONFIG.reconnectInterval && clearInterval(YTX_CONFIG.reconnectInterval)
        ...
        var chatMethods = {
            ...
            buildSendTxt: function (data, callback, onError) {
                ...
                if (data.atAccounts) {
                    ...
                    sendObj['11'] = Base64.encode(JSON.stringify({
                        at: atAccounts
                    }));
                }
    ...
    function RL_MEET() {
        ...
        this.__proto__ = {
            ...
            StartWhiteboardSharing(data, callback, onError) {
                meetMethods.buildConferenceMsg("/REST/Conference/MediaControl/StartWhiteboardSharing?source=SDK", {
                    confId: this.confId,
                    ...data
                }, e => {
                    let resp = JSON.parse(e.result);
            ...
            StopWhiteboardSharing(data, callback, onError) {
                meetMethods.buildConferenceMsg("/REST/Conference/MediaControl/StopWhiteboardSharing?source=SDK", {
                    confId: this.confId,
                    ...data
                }, e => {
                    let resp = JSON.parse(e.result);
            ...
            ConferenceUpdate(data, callback, onError) {
                meetMethods.buildConferenceMsg("/REST/Conference/Update?source=SDK", {
                    confId: this.confId,
                    ...data
                }, e => {
                    let resp = JSON.parse(e.result);
            ...
            CreateMeet(data, callback, onError) {
                meetMethods.buildConferenceMsg("/REST/Conference/Create?source=SDK", data, e => {
            ...
            GetOrderMeetList(data, callback, onError) {
                meetMethods.buildConferenceMsg("/REST/Conference/List?source=SDK", data, e => {
                    let resp = JSON.parse(e.result);
                    if (resp.statusCode == "000000") {
                        callback(resp);
                    } else {
            ...
            StartPublishVoice(data, callback, onError) {
                ...
                meetMethods.buildConferenceMsg("/REST/Conference/MediaControl/StartPublishVoice?source=SDK", {
                    confId: this.confId,
                    ...data
                }, callback, onError);
            },
            ...
            StopPublishVoice(data, callback, onError) {
                ...
                meetMethods.buildConferenceMsg("/REST/Conference/MediaControl/StopPublishVoice?source=SDK", {
                    confId: this.confId,
                    ...data
                }, callback, onError);
            },
            ...
            StartPublishVideo(data, callback, onError) {
                ...
                meetMethods.buildConferenceMsg("/REST/Conference/MediaControl/StartPublishVideo?source=SDK", {
                    confId: this.confId,
                    ...data
                }, e => {
                    let resp = JSON.parse(e.result);
            ...
            StopPublishVideo(data, callback, onError) {
                ...
                meetMethods.buildConferenceMsg("/REST/Conference/MediaControl/StopPublishVideo?source=SDK", {
                    confId: this.confId,
                    ...data
                }, e => {
                    let resp = JSON.parse(e.result);
            ...
            InviteMember(data, callback, onError) {
                meetMethods.buildConferenceMsg("/REST/Conference/Member/Invite?source=SDK", {
                    confId: this.confId,
                    ...data
                }, e => {
                    let resp = JSON.parse(e.result);
            ...
            MediaControl(data, callback, onError) {
                meetMethods.buildConferenceMsg("/REST/Conference/Member/MediaControl?source=SDK", {
                    confId: this.confId,
                    ...data
                }, callback, onError);
            },
            ...
            leaveMeeting(data, callback, onError) {
                ...
                meetMethods.buildConferenceMsg("/REST/Conference/Member/Quit?source=SDK", {
                    confId: this.confId,
                    ...data
                }, callback, onError);
            ...
            DeleteMeeting(data, callback, onError) {
                meetMethods.buildConferenceMsg("/REST/Conference/Delete?source=SDK", {
                    confId: this.confId,
                    ...data
                }, callback, onError);
            ...
            GetAbstractList(data, callback, onError) {
                meetMethods.buildConferenceMsg("/REST/Conference/Abstract/List?source=SDK", data, e => {
                    if (e.result) {
                        let result = JSON.parse(e.result);
                        if (result.statusCode === "000000") {
                            callback(result);
            ...
            UpdateAbstract(data, callback, onError) {
                meetMethods.buildConferenceMsg("/REST/Conference/Abstract/Update?source=SDK", {
                    confId: this.confId,
                    ...data
                }, callback, onError);
            },
            ...
            LockMeet(data, callback, onError) {
                meetMethods.buildConferenceMsg("/REST/Conference/LockUnlock?source=SDK", {
                    confId: this.confId,
                    ...data
                }, callback, onError);
            },
